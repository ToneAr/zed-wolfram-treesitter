//! This crate provides Wolfram language support for the [tree-sitter] parsing library.
//!
...
//! let language = tree_sitter_wolfram::LANGUAGE;
//! parser
//!     .set_language(&language.into())
//!     .expect("Error loading Wolfram parser");
